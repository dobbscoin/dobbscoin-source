Dobbscoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/dobbscoin/files/Dobbscoin/dobbscoin-0.5.4/
...
Fix Dobbscoin-Qt notifications under Growl 1.3.
Increase required age of Dobbscoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDobbscoin properly when installing Dobbscoin-Qt over it. (Windows)
