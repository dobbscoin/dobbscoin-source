Dobbscoin Core version 0.9.4 is now available from:

  https://dobbscoin.org/bin/0.9.4/
...
this update is incompatible with the Dobbscoin system and could lead to consensus
forks.

Dobbscoin Core released binaries from https://dobbscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~dobbscoin/+archive/ubuntu/dobbscoin
- A third-party or self-compiled Dobbscoin Core

upgrade to Dobbscoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
