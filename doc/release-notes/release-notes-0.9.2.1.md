Dobbscoin Core version 0.9.2.1 is now available from:

  https://dobbscoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BOB to 0.01 BOB
...
- Fix "Start dobbscoin on system login"
