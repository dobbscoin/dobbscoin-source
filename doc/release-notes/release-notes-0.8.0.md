Dobbscoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/dobbscoin/files/Dobbscoin/dobbscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Dobbscoin
...
New/changed settings (command-line or dobbscoin.conf file)
--------------------------------------------------------
