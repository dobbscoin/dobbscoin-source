...
http://sourceforge.net/projects/dobbscoin/files/Bitcoin/dobbscoin-0.6.0/test/
...
versions of Bitcoin-Qt/dobbscoind.
...
dobbscoin: URIs onto the Bitcoin-Qt window to start
payment.
