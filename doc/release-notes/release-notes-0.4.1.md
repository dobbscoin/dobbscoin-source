Dobbscoin version 0.4.1 is now available for download at:
http://sourceforge.net/projects/dobbscoin/files/Dobbscoin/dobbscoin-0.4.1/
...
If you have a previously encrypted wallet.dat, the first time you run wxdobbscoin or dobbscoind the wallet will be rewritten, Dobbscoin will
...
wxDobbscoin: new address visible on main window
