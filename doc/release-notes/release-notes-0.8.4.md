Bitcoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/dobbscoin/files/Bitcoin/dobbscoin-0.8.4/
...
/Applications/Bitcoin-Qt (on Mac) or dobbscoind/dobbscoin-qt (on Linux).
...
code, causing the Bitcoin-Qt or dobbscoind process to crash.
