Download URL: https://sourceforge.net/projects/dobbscoin/files/Dobbscoin/dobbscoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BOB fee schedule (users still pay 0.01 BOB per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #dobbscoin00 - #dobbscoin99
