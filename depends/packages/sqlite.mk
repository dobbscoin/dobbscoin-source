package=sqlite
# The wallet's storage engine (replaced Berkeley DB 4.8, see issue #44).
# Same release and sha256 as Bitcoin Core's depends/packages/sqlite.mk (v23-v28).
...
$(package)_config_opts+= --disable-rtree --disable-fts4 --disable-fts5 --enable-threadsafe
