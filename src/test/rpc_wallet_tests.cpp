...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CDobbscoinAddress demoAddress = CDobbscoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CDobbscoinAddress setaccountDemoAddress = CDobbscoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CDobbscoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CDobbscoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
