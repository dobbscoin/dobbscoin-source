...
Value getgenerate(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "It is set with the command line argument -gen (or dobbscoin.conf setting gen)\n"
...
Value setgenerate(const Array& params, bool fHelp)
{
    ...
    else // Not -regtest: start generate thread, return immediately
    {
        ...
        GenerateDobbscoins(fGenerate, pwalletMain, nGenProcLimit);
    }
...
Value getwork(const Array& params, bool fHelp)
{
   ...
   //     throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Bitcoin is downloading blocks...");
    ...
    else
    {
        ...
        mtx.vin[0].scriptSig=mapNewBlock[pdata->hashMerkleRoot].second;
        //pblock->vtx[0].vin[0].scriptSig = (CScript)mapNewBlock[pdata->hashMerkleRoot].second;
...
// NOTE: Unlike wallet RPC (which use BOB values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "See https://en.dobbscoin.it/wiki/BIP_0022 for full specification.\n"
