...
###   This script attempts to download the signature file SHA256SUMS.asc from dobbscoin.org
...
WORKINGDIR="/tmp/dobbscoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://dobbscoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://dobbscoin.org/bin/"
VERSIONPREFIX="dobbscoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'dobbscoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[dobbscoin-]<version>-[rc[0-9]] (example: dobbscoin-0.9.2-rc1)"
   echo "wget output:"
